...
def train_curriculum(args: argparse.Namespace, config: Dict[str, Any]) -> None:
    ...
    # CUDA visibility must be configured before importing torch/transformers or
    # calling set_seed(), because either can initialize CUDA and lock in the
    # previously visible physical devices.
